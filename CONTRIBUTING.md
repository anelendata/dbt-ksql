...
Report bugs at https://github.com/anelendata/dbt-ksql
...
dbt-ksql could always use more documentation, whether as part of the
...
3. The pull request should work for Python 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.org/anelendata/dbt-ksql/pull_requests
